					...
					case 1: for(int i=1; i<=num ; i++)
							{
								...
								grade = in.nextDouble();
								first_sheet.setGrade(i,grade);
							}
							break;
					case 2: System.out.println("Enter student number:");
						    num = in.nextInt();
						    System.out.println("Grade of student" + num + ":" + first_sheet.getGrade(num));
						    break;
					case 3: System.out.println("Average grade:" + first_sheet.averageGrade());
						    break;
