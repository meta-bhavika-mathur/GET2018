...
class Marksheet
{
	final String error_message_one = "Number of students should be greater than 0";
	int no_of_students;
	double[] grades;
	...
	{
		if( n <= 0 )
			throw new ArithmeticException(error_message_one);
		no_of_students = n;
	 ...
	 */
	public double getStudentGrade(int student)  
	{
