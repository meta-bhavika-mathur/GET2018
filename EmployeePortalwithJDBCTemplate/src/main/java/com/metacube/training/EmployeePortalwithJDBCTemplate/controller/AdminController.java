...
import com.metacube.training.EmployeePortalwithJDBCTemplate.service.EmployeeService;
import com.metacube.training.EmployeePortalwithJDBCTemplate.service.JobService;
import com.metacube.training.EmployeePortalwithJDBCTemplate.service.ProjectService;
import com.metacube.training.EmployeePortalwithJDBCTemplate.service.SkillService;
...
/*    @RequestMapping(value = "/updateJob", method = RequestMethod.GET)
   ...
   /* @RequestMapping(value = "/updateJob", method = RequestMethod.GET)
    ...
    public String searchEmployee(@RequestParam(value = "firstName") String firstName)
    {
        if (firstName != null)
        {
            employeeService.getByFirstName(firstName);
