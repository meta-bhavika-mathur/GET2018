...
import com.metacube.training.EmployeePortalwithJDBCTemplate.mapper.EmployeeMapper;
...
public class EmployeeDAO
{
   ...
   private final String SQL_SEARCH_EMPLOYEE_BY_NAME = "select * from employee where first_name = ?";
   ...
   public Employee getByFirstName(String firstName)
   {
       try
       {
           return jdbcTemplate.queryForObject(SQL_SEARCH_EMPLOYEE_BY_NAME,
                   new Object[] { firstName }, new EmployeeMapper());
       } catch (EmptyResultDataAccessException e)
       {
           return null;
       }
