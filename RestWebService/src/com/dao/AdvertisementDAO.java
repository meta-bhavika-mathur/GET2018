...
public class AdvertisementDAO implements BaseDAO<Advertisement>
{
   ...
   {
       connection = JDBCConnectivity.getMysqlConnection("root", "1234", "AdvertisementInformation");
   }
   ...
   /**
    * Returns list of all advertisements stored in the table
    */
   public List<Advertisement> getAll()
   {
       ...
       )
       {
           ...
           {
               int id = resultSet.getInt("advertisement_id");
               String title = resultSet.getString("advertisement_title");
               String description = resultSet.getString("advertisement_description");
   ...
   /**
    * Deletes advertisement from advertsement table
    */
